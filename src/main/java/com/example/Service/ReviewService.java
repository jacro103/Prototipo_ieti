...
public class ReviewService {
    ...
    public GenericResponse<ArrayList<Review>> getReviews (){
        ...
        try {
            ...
            return new GenericResponse<ArrayList<Review>>(HttpStatus.OK, "OK", true, list);

        } catch (Exception exception) {
            return new GenericResponse<ArrayList<Review>>(HttpStatus.INTERNAL_SERVER_ERROR, exception.getMessage(),
                    false, null);
        }
    }
    ...
    public GenericResponse<Optional<Review>> getById(Long id){        
        try {
            return new GenericResponse<Optional<Review>>(HttpStatus.OK, "OK", true, reviewRepository.findById(id));

        } catch (Exception exception) {
            return new GenericResponse<Optional<Review>>(HttpStatus.INTERNAL_SERVER_ERROR, exception.getMessage(),
                    false, null);
        }
    }
